...
struct VPlane
{
    ...
    VPlane(const Vector & vecNormal, const float flDistance) :
        m_Normal(vecNormal), m_Dist(flDistance) { }
...
public:
    ...
    virtual void			DrawBrushModelShadowDepth(IClientEntity* pEntity, void* pModel, const Vector& vecOrigin, const Vector& angView, int nDepthMode) = 0;
    virtual void			UpdateBrushModelLightmap(void* pModel, IClientRenderable* pRenderable) = 0;
    ...
    virtual void			DrawBrushModelEx(IClientEntity* pEntity, void* pModel, const Vector& vecOrigin, const Vector& angView, int nMode) = 0;
