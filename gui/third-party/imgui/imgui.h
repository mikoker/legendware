...
#endif
    bool operator == (ImVec2 &rhs){ return this->x == rhs.x && this->y == rhs.y;  }
    bool operator != (ImVec2 &rhs){ return !(*this == rhs); }
    bool operator == (const ImVec2& rhs) { return this->x == rhs.x && this->y == rhs.y; }
    bool operator != (const ImVec2& rhs) { return !(*this == rhs); }
};
...
namespace ImGui
{
    ...
    IMGUI_API void          Render(ImDrawList* our_list = NULL);                                   // ends the Dear ImGui frame, finalize the draw data. You can get call GetDrawData() to obtain it and run your rendering function (up to v1.60, this used to call io.RenderDrawListsFn(). Nowadays, we allow and prefer calling your render function yourself.)
    ...
    IMGUI_API void          Text(ImFont* font, float font_size, const char* fmt, ...);
    IMGUI_API void          TextV(ImFont* font, float font_size, const char* fmt, va_list args);
    ...
    IMGUI_API void          Image(ImTextureID user_texture_id, const ImVec2& size, const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1,1), const ImVec4& tint_col = ImVec4(1,1,1,1), const ImVec4& border_col = ImVec4(0,0,0,0), float rounding = 0.0f);
    ...
    IMGUI_API bool          BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags = 0, float* expected_h = nullptr, bool* close = nullptr);
    ...
    IMGUI_API bool          InputText(const char* label, char* buf, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL, const ImVec2& size = ImVec2(0.0f, 0.0f));
    IMGUI_API bool          InputTextMultiline(const char* label, char* buf, size_t buf_size, const ImVec2& size = ImVec2(0, 0), ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
    IMGUI_API bool          InputTextWithHint(const char* label, const char* hint, char* buf, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
    IMGUI_API bool          InputFloat(const char* label, float* v, float step = 0.0f, float step_fast = 0.0f, const char* format = "%.3f", ImGuiInputTextFlags flags = 0, const ImVec2& size = ImVec2(0, 0));
    IMGUI_API bool          InputFloat2(const char* label, float v[2], const char* format = "%.3f", ImGuiInputTextFlags flags = 0, const ImVec2& size = ImVec2(0, 0));
    IMGUI_API bool          InputFloat3(const char* label, float v[3], const char* format = "%.3f", ImGuiInputTextFlags flags = 0, const ImVec2& size = ImVec2(0, 0));
    IMGUI_API bool          InputFloat4(const char* label, float v[4], const char* format = "%.3f", ImGuiInputTextFlags flags = 0, const ImVec2& size = ImVec2(0, 0));
    IMGUI_API bool          InputInt(const char* label, int* v, int step = 1, int step_fast = 100, ImGuiInputTextFlags flags = 0, const ImVec2& size = ImVec2(0, 0));
    IMGUI_API bool          InputInt2(const char* label, int v[2], ImGuiInputTextFlags flags = 0, const ImVec2& size = ImVec2(0, 0));
    IMGUI_API bool          InputInt3(const char* label, int v[3], ImGuiInputTextFlags flags = 0, const ImVec2& size = ImVec2(0, 0));
    IMGUI_API bool          InputInt4(const char* label, int v[4], ImGuiInputTextFlags flags = 0, const ImVec2& size = ImVec2(0, 0));
    IMGUI_API bool          InputDouble(const char* label, double* v, double step = 0.0, double step_fast = 0.0, const char* format = "%.6f", ImGuiInputTextFlags flags = 0, const ImVec2& size = ImVec2(0, 0));
    IMGUI_API bool          InputScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_step = NULL, const void* p_step_fast = NULL, const char* format = NULL, ImGuiInputTextFlags flags = 0, const ImVec2& size = ImVec2(0, 0));
    IMGUI_API bool          InputScalarN(const char* label, ImGuiDataType data_type, void* p_data, int components, const void* p_step = NULL, const void* p_step_fast = NULL, const char* format = NULL, ImGuiInputTextFlags flags = 0, const ImVec2& size = ImVec2(0, 0));
    ...
    IMGUI_API ImVec2        CalcTextSize(ImFont* font, const char* text, const char* text_end = NULL, bool hide_text_after_double_hash = false, float wrap_width = -1.0f);
...
enum ImGuiWindowFlags_
{
    ...
    ImGuiWindowFlags_DrawShadow             = 1 << 29,

    // [Custom]
    ImGuiWindowFlags_RoundLeft              = 1 << 30
...
enum ImGuiComboFlags_
{
    ...
    ImGuiComboFlags_ColorPicker             = 1 << 7,
...
enum ImGuiCol_
{
    ...
    ImGuiCol_SubChild,
    ImGuiCol_Keybinds,
    ImGuiCol_KeybindsBody,
    ImGuiCol_ButtonEx,
    ImGuiCol_ButtonHoveredEx,
    ImGuiCol_ButtonActiveEx,
    ImGuiCol_LuaEditorBg, 
    ImGuiCol_ButtonDisabled,
    ImGuiCol_ButtonDisabledText,
    ImGuiCol_COUNT
...
enum ImGuiStyleVar_
{
    ...
    ImGuiStyleVar_ScrollbarOffset,     // ImVec2    ScrollbarOffset
    ImGuiStyleVar_COUNT
...
enum ImGuiSliderFlags_
{
    ...
    ImGuiSliderFlags_OnMouseReleased        = 1 << 8,
    ImGuiSliderFlags_NoneIfZero             = 1 << 9,
...
namespace ImGui
{
    ...
    IMGUI_API bool      InputFloat(const char* label, float* v, float step, float step_fast, int decimal_precision, ImGuiInputTextFlags flags = 0, const ImVec2& size = ImVec2(0, 0)); // Use the 'const char* format' version instead of 'decimal_precision'!
    IMGUI_API bool      InputFloat2(const char* label, float v[2], int decimal_precision, ImGuiInputTextFlags flags = 0, const ImVec2& size = ImVec2(0, 0));
    IMGUI_API bool      InputFloat3(const char* label, float v[3], int decimal_precision, ImGuiInputTextFlags flags = 0, const ImVec2& size = ImVec2(0, 0));
    IMGUI_API bool      InputFloat4(const char* label, float v[4], int decimal_precision, ImGuiInputTextFlags flags = 0, const ImVec2& size = ImVec2(0, 0));
...
#define IM_COL32A(R,G,B)     IM_COL32(R,G,B,255)
...
struct FuckImguiChecks
{
    ImVec4          v;           // 4*4  // Clipping rectangle (x1, y1, x2, y2). Subtract ImDrawData->DisplayPos to get clipping rectangle in "viewport" coordinates
    bool            ClipRectCircle;     // 1
};
struct ImDrawCmd
{
    FuckImguiChecks ClipRect;        // 4*4  // Clipping rectangle (x1, y1, x2, y2). Subtract ImDrawData->DisplayPos to get clipping rectangle in "viewport" coordinates
...
struct ImDrawList
{
    ...
    ImVector<bool>          _ClipRectStackCircle;
    ...
    IMGUI_API void  PushClipRect(ImVec2 clip_rect_min, ImVec2 clip_rect_max, bool intersect_with_current_clip_rect = false, bool circle_Scissor = false);  // Render-level scissoring. This is passed down to your render function but not used for CPU-side coarse clipping. Prefer using higher-level ImGui::PushClipRect() to affect logic (hit-testing and widget culling)
    ...
    IMGUI_API void  AddShadowRect(const ImVec2& obj_min, const ImVec2& obj_max, ImU32 shadow_col, float shadow_thickness, const ImVec2& shadow_offset = ImVec2(0, 0), ImDrawShadowFlags shadow_flags = 0, float obj_rounding = 0.0f, ImDrawCornerFlags obj_rounding_corners = ImDrawCornerFlags_All);
    IMGUI_API void  AddShadowCircle(const ImVec2& obj_center, float obj_radius, ImU32 shadow_col, float shadow_thickness, const ImVec2& shadow_offset = ImVec2(0, 0), ImDrawShadowFlags shadow_flags = 0, int obj_num_segments = 12);
    IMGUI_API void  AddShadowConvexPoly(const ImVec2* points, int points_count, ImU32 shadow_col, float shadow_thickness, const ImVec2& shadow_offset = ImVec2(0, 0), ImDrawShadowFlags shadow_flags = 0);
    IMGUI_API void  AddShadowNGon(const ImVec2& obj_center, float obj_radius, ImU32 shadow_col, float shadow_thickness, const ImVec2& shadow_offset = ImVec2(0, 0), ImDrawShadowFlags shadow_flags = 0, int obj_num_segments = 15);
