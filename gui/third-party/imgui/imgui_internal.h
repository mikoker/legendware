...
#define ImCos(X)            DirectX::XMScalarCosEst(X)
#define ImSin(X)            DirectX::XMScalarSinEst(X)
#define ImAcos(X)           DirectX::XMScalarACosEst(X)
...
struct ImGuiContext
{
    ...
    std::map<ImGuiID, float>Animations;
...
namespace ImGui
{
    ...
    IMGUI_API void          RenderText(ImFont* font, float font_size, ImVec2 pos, const char* text, const char* text_end, bool hide_text_after_hash);
    IMGUI_API void          RenderTextWrapped(ImFont* font, float font_size, ImVec2 pos, const char* text, const char* text_end, float wrap_width);
    ...
    IMGUI_API void          RenderFrame(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, bool border = true, float rounding = 0.0f, ImDrawCornerFlags flags = ImDrawCornerFlags_All);
    ...
    IMGUI_API void          TextEx(ImFont* font, float font_size, const char* text, const char* text_end = NULL, ImGuiTextFlags flags = 0);
